/** biome-ignore-all lint/performance/noImgElement: fix next img */
...
const DefaultPfp = () => (
  <div tw="flex justify-center items-center w-[57px] h-[57px] p-[10px]">
    <svg fill="white" height="47px" viewBox="0 0 512 512" width="47px">
      <title>Default PFP</title>
      <g>
        <path
          className="st0"
          d="M445.21,438.315c-10.7-20.671-27.49-34.113-43.889-43.241c-16.399-9.146-32.825-14.33-43.578-18.379
